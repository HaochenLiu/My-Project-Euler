...
bool isPalindrome(bignum num) {
    return isPalindrome(bignumtos(num));
}

bignum reverse(bignum num) {
    string str = bignumtos(num);
    reverse(str.begin(), str.end());
    return stobignum(str);
}
